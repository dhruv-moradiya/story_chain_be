export const TOKENS = {
  ...
  StoryStatsService: Symbol.for('StoryStatsService'),
  ExploreStoriesService: Symbol.for('ExploreStoriesService'),
  ...
  ChapterUnlockService: Symbol.for('ChapterUnlockService'),
